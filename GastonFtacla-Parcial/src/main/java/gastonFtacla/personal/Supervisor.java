...
public class Supervisor extends Empleado {
    ...
    public Supervisor(String nombre) {
        ...
        // TODO [Mai] Podes usar constantes, es más prolijo
    }
    ...
    public void calcularSueldoMensual() {
        ...
        super.setSueldoFinal(this.sueldoBasico + (ventasDeVendedores * 0.03)); // TODO [Mai] Podes usar constantes, es más prolijo
    }
}
